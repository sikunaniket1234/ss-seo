...
export class SEOAnalyzer {
    public static async analyze(html: string, url: string = ''): Promise<SEOAuditReport> {
        ...
        return {
            ...
            suggestedTags: await AIIntelligenceService.generateSuggestions(data, AIIntelligenceService.extractKeywords(html))
        };
    }
